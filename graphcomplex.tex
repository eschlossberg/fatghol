...
defined in \csref{dfn:fatgraphs}, as opposed to \emph{embedded}
fatgraphs as in \csref{dfn:embedded-rg} below.
...
Recall that in \csref{lemma:S-functor}, a triangulation of the surface
...
\item For any non-loop edge $\alpha \in \Edges{G}$, let $V_\alpha :=
  ...
  in the construction of \csref{lemma:S-functor}.
...
\begin{proof}
  ...
  \csref{lemma:S-functor}(b).  Form the dual graph to ${\tilde G}$:
