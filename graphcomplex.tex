...
equivalence to $\T_{g,n}$ and $\M_{g,n}$.\FIXME{%
  Mi sembra che i risultati di questa sezione non siano utilizzati nel
  resto del capitolo; magari spostarla da un'altra parte, cos\`\i{} da
  alleggerire la trattazione qui?}
...
contractions and the identity as morphisms.\FIXME{%
