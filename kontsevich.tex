\RCSID $Id: kontsevich.tex,v 1.5 2006/05/13 16:34:34 rmurri Exp $
% auto-ignore
...
This chapter is an exposition of Kontsevich' Theorem
\cite[Theorem 1.1]{kontsevich;intersection-theory;1992} relating the
...
For non-negative integers $\nu_1, \ldots, \nu_n$, define\FIXME{Controllare la notazione!!}
\begin{equation}
...
\begin{definition}\FIXME{Togliere? Direi che possiamo dare per
    scontato che si conosca la definizione di espansione asintotica\ldots}
...
\begin{theorem}[Kontsevich, {\cite[Theorem
  ...
  the form $\omega$ (defined in \csref{thm:comb-bundle}) under $b_j$
...
\begin{proof}[Proof of \csref{thm:kontsevich}]
  ...
  By \csref{thm:FRT}, the $m$-th summand in the right-hand side
