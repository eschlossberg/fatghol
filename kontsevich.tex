\RCSID $Id: kontsevich.tex,v 1.3 2003/09/09 16:12:30 murri Exp $
%auto-ignore
...
\begin{theorem}[Kontsevich, {\cite[Theorem
  ...
  dual of the complex line bundle ${\Lb}_j$. The pull-back $\omega_j$ of
...
a cyclic algebra structure on $\Hermitian[N \otimes \setC \simeq \End(V)$ called the
Kontsevich model. A graphical calculus $Z$ for the Kontsevich model is
~defined on the PROP $\RG$ of ribbon graphs.
