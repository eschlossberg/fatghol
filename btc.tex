...
\item is associative up to a natural isomorphism $a = a_{ABC}:
  ...
  \begin{equation*}
    \xymatrix{%
      ...
      \ar "1,1";"1,2"^{a}
      \ar "1,2";"1,3"^{a}
      \ar "1,1";"2,1"_{a \otimes \idmap}
      \ar "2,1";"2,3"_{a}
      \ar "2,3";"1,3"_{\idmap \otimes a}
      }
  \end{equation*}
\item has a unit $I \in \A$ again up to a natural isomorphism, that is,
  ...
  \begin{equation*}
    \xymatrix{%
      ...
      &
      \ar "1,1";"1,3"^{a}
      \ar "1,1";"2,2"_{r \otimes \idmap}
      \ar "1,3";"2,2"^{\idmap \otimes l}
      }
  \end{equation*}
\end{enumerate}
...
\begin{equation*}
  \xymatrix{%
    ...
    \ar "1,1";"1,2" ^{\digamma_2 \otimes \idmap}
    \ar "2,1";"2,2" _{\digamma_2}
    \ar "1,1";"2,1" _{\idmap \otimes \digamma_2}
  ...
  \xymatrix{%
    ...
    \ar "1,1";"1,2" ^{l_\B}
    \ar "2,1";"2,2" _{\digamma_2}
    \ar "1,1";"2,1" _{\digamma_0 \otimes \idmap}
    \ar "2,2";"1,2" _{F(l_\A)}
    }
  \quad
    \xymatrix{%
    ...
    \ar "1,1";"1,2" ^{r_\B}
    \ar "2,1";"2,2" _{\digamma_2}
    \ar "1,1";"2,1" _{\idmap \otimes \digamma_0}
    \ar "2,2";"1,2" _{F(r_\A)}
    }
\end{equation*}
...
\end{equation*}
by an inductive process: $\digamma_0$ is given, $\digamma_1 := \idmap$, $\digamma_2$ is
given, and $\digamma_{n+1}$ is the composite
\begin{equation*}
    FA_1 \otimes \cdots \otimes FA_{n+1}
    \xrightarrow{\digamma_n \otimes \idmap}
...
\item
  ...
  functors, and 
\item any diagram built using only the structure maps $\idmap$, $a$, $l$,
...
\begin{proposition}[{\cite[Prop.\ 2.1]{joyal-street;btc}}]
  ...
  \begin{equation*}
    \xymatrix{%
      ...
      C\otimes(B\otimes A)
      \ar"1,1";"1,2" ^{a} 
      \ar"1,2";"1,3" ^{\idmap\otimes\tau}
      \ar"1,3";"1,4" ^{a\inv}
      \ar"1,1";"2,1" _{\tau\otimes\idmap}
      \ar"1,4";"2,4" ^{\tau\otimes\idmap}
      \ar"2,1";"3,1" _{a}
      \ar"2,4";"3,4" ^{a}
      \ar"3,1";"4,1" _{\idmap\otimes\tau}
      \ar"3,4";"4,4" ^{\idmap\otimes\tau}
      \ar"4,1";"4,2" _{a\inv}
      \ar"4,2";"4,3" _{\tau\otimes\idmap}
      \ar"4,3";"4,4" _{a}
      }
  \end{equation*}
\end{proposition}
...
\begin{proposition}[{\cite[Example 2.5]{joyal-street;btc}}]
  \label{thm:rev}
  The assignment $F := \Id$, $\digamma_2 := \tau$, $\digamma_0 := \idmap$ defines a a
...
\begin{definition}
  If $\tau_{AB} \circ \tau_{BA} = \idmap_{AB}$ then the braiding is called a
  \emph{symmetry}.   
\end{definition}
...
\begin{definition}[\cite{joyal-street;btc}]
  ...
  isomorphisms $\theta_A:A\to A$ such that $\theta_I = \idmap_I$ and 
  \begin{equation*}
    \xymatrix{%
      A\otimes B
      &
...
By Theorem~\ref{thm:rev}, a braiding $\tau$ determines a monoidal isomorphism
