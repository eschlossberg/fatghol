...
a list or tuple (see \csref{sec:lists} and~\ref{sec:tuples}). For
...
\csref{sec:dicts}) mapping each parameter name to the actual value
...
When "x" is a "list" or "tuple" object (see \csref{sec:lists} and
\csref{sec:tuples}), the syntax "f(*x)" invokes function "f"
